...
int main()
{
  FILE *fp,*fp1,*fp2,*fp3,*fp4;
     fp=fopen("C:\\Users\\username\\My Documents\\C_files\\Simulation_result3.txt","w");
  	fp1=fopen("C:\\Users\\username\\My Documents\\C_files\\Simulation_result3.1.txt","w");
     fp2=fopen("C:\\Users\\username\\My Documents\\C_files\\Simulation_result3.2.txt","w");
      fp3=fopen("C:\\Users\\username\\My Documents\\C_files\\Simulation_result3.3.txt","w");
      fp4=fopen("C:\\Users\\username\\My Documents\\C_files\\Simulation_result3.4.txt","w");
...
/* A function to the shortest path for transmissions from each node to basestation */
	...
	void shortpath(float cost[][mxNo],int *preced,float *distance)
	{
	  ...
	  distance[0]=0;
	  current=0;
	  for(j=allselected(selected);j<mxNo;j++)
	  {
	  	smalldist=INFINITE;
	    dc=distance[current];
	    for(ii=0;ii<mxNo;ii++)
